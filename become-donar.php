...
<div><input type="text" name="fullname" pattern="^[A-Z a-z]*$"  class="form-control" required minlength="4"></div>
</div>
<div class="col-lg-4 mb-4">
<div class="font-italic">Mobile Number<span style="color:red">*</span></div>
<div><input type="tel" id="phone" name="phone" pattern="+91[0-9]{10}" required minlength="10" maxlength="13" size="13"></div>
</div>
<div class="col-lg-4 mb-4">
<div class="font-italic">Email Id</div>
<div><input type="email" id="email" name="emailid" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required></div>
</div>
</div>
...
<div><input type="number" size="4" name="age" min="18" required style="display:Must be above 18;"></div>
</div>
